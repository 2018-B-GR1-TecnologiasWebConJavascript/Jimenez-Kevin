                                                ...
                                                comics.forEach((miComic, index) => {
                                                    if (miComic) {
                                                        ...
                                                        if (existeComic) {
                                                            inquirer.prompt(opcionesMenu.atributosComic)
                                                                .then(comic => {
                                                                    miComic['Nombre Comic'] = comic['Nombre Comic']
                                                                    miComic['Fecha Publicacion'] = comic['Fecha Publicacion']
                                                                    miComic['Genero'] = comic['Genero']
                                                                    
                                                                    comics.forEach(value => {
                                                                        if (value) {
                                                                            const leerYEscribirArchivo$ = rxjs.from(funciones.escribirArchivo(JSON.stringify(value), 'DC'));
                                                                            leerYEscribirArchivo$
                                                                                .subscribe(respuesta => {
                                                                                    console.log(respuesta);
                                                                                });
